...
export const createRequest = asyncHandler(async (req, res, next) => {
  ...
  const emailMessage = `
            <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                ...
                <p>You have received a new connection request from <strong>${req.user.name} (${req.user.username})</strong>.</p>
                ...
                <p><a href="http://localhost:5173/chats" style="background-color: #4CAF50; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">View Requests</a></p>
...
export const acceptRequest = asyncHandler(async (req, res, next) => {
  ...
  console.log("ReceiverId (current user):", req.user._id);
