...
// Unified user details endpoint used by the frontend
router.get("/getDetails", verifyJWT_username, userDetailsWithoutID);
...
// Upload Picture
router.route("/uploadPicture").post(
  verifyJWT_username,
...
// Upload Cover Image
router.route("/uploadCoverImage").post(
  verifyJWT_username,
