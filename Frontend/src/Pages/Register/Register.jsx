...
const Register = () => {
  ...
  useEffect(() => {
    // If user is already logged in, redirect to edit profile or home
  ...
  return (
    <div className="register_page ">
      <h1 className="m-4" style={{ fontFamily: "Oswald", color: "var(--cyan)" }}>
        Registration Form
      </h1>
      {loading ? (
          ...
          >
            <Tab eventKey="registration" title="Registration">
              ...
              <div>
                ...
                />
                <datalist id="skills-proficient-list">
